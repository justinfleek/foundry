/-
  Foundry.Cornell.Sigil - Verified SIGIL Wire Format with Reset-on-Ambiguity
...
open Foundry.Cornell.Proofs (Bytes ParseResult)
...
def StrictBox.fromBox (box : Foundry.Cornell.Proofs.Box α) : StrictBox α where
