/-
  Cornell.ExtractHaskell - Haskell Code Generation for SIGIL State Machine
  
  Generates Evring.Sigil module from the Lean specification in Foundry.Cornell.Sigil.
...
-- Source: Cornell.ExtractHaskell (from Foundry.Cornell.Sigil specification)
--
...
def genChunkTypes : String :=
"-- ═══════════════════════════════════════════════════════════════════════════════
-- CHUNK TYPES
-- Generated from: Foundry.Cornell.Sigil.ChunkContent, Foundry.Cornell.Sigil.Chunk
-- ═══════════════════════════════════════════════════════════════════════════════
...
{- |
== Verified Properties (from Foundry.Cornell.Sigil)
...
#eval IO.println genSigilHs

end Cornell.ExtractHaskell

-- Main entry point
def main : IO Unit := do
  IO.println Cornell.ExtractHaskell.genSigilHs
