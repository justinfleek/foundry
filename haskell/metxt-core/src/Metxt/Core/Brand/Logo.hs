...
DEPENDENCIES:
  - Metxt.Core.Brand.Logo.Sizing
  - Metxt.Core.Brand.Logo.Usage

DEPENDENTS:
  - Metxt.Core.Brand (compound Brand type)
-}
module Metxt.Core.Brand.Logo
  ( -- * Logo Components
    LogoComponent (..)
  ...
  , module Metxt.Core.Brand.Logo.Usage
...
import Metxt.Core.Brand.Logo.Sizing
  ( ClearSpaceRule (..)
  , mkClearSpaceRule
  , MinimumSize (..)
  , mkMinimumSize
...
import Metxt.Core.Brand.Logo.Usage
  ( UsageContext (..)
  , usageContextToText
  , parseUsageContext
  , LogoUsageRule (..)
