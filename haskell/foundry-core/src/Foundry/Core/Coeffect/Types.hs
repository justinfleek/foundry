...
--                                                              — Neuromancer
--
-- Coeffect types for tracking resource requirements. Ported from straylight-llm
-- production code. Mirrors the structure defined in DischargeProof.dhall and
-- the Lean4 formalization in Continuity.lean.
--
-- Key types:
...
module Foundry.Core.Coeffect.Types
    ( -- * Coeffect Types
